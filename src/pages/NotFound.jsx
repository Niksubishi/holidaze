  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: theme.colors.background }}>
      <div className="text-center">
        <div className="mb-8">
          <h1 className="font-poppins text-6xl md:text-8xl mb-4" style={{ color: theme.colors.text }}>
            404
          </h1>
          <h2 className="font-poppins text-2xl md:text-3xl mb-4" style={{ color: theme.colors.text }}>
            Page Not Found
          </h2>
          <p className="font-poppins text-lg mb-8 max-w-md" style={{ color: theme.colors.text }}>
