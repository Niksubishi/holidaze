...
const VenueCard = ({ venue }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <h3 className="font-chivo text-lg text-white mb-2 line-clamp-2">
          {venue.name}
        </h3>

        <p className="font-lora text-gray-300 text-sm mb-2">
          {formatLocation()}
        </p>

        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center">
            <span className="font-chivo text-xl text-white">
              ${venue.price}
            </span>
            <span className="font-lora text-gray-300 text-sm ml-1">
              / night
            </span>
          </div>
        ...
        <p className="font-lora text-gray-400 text-xs mb-2">
        ...
        {venue.owner && (
          <div className="mb-2">
            <button
              ...
              className="font-lora text-primary text-xs hover:text-opacity-80 transition-colors cursor-pointer"
            >
